                                ...
                                <td>
                                    <span class="fw-bold">
                                        <?php if(@$withdraw->method->name): ?>
                                            <a href="<?php echo e(appendQuery('method',@$withdraw->method->id)); ?>"> <?php echo e(__(@$withdraw->method->name)); ?></a>
                                        <?php else: ?>
                                            <?php echo app('translator')->get('Epin'); ?>
                                        <?php endif; ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u171472567/domains/yukotrader.com/public_html/core/resources/views/admin/withdraw/withdrawals.blade.php ENDPATH**/ ?>