...
.login-box label {
    ...
    <div class="login-container">
        <div class="login-box">
            ...
            <h3><?php echo app('translator')->get('Sign In to your account'); ?></h3>
            <form method="POST" action="<?php echo e(route('user.login')); ?>" class="contact-form verify-gcaptcha">
                <?php echo csrf_field(); ?>
                <div>
                    <label><?php echo app('translator')->get('Username or Email'); ?></label>
                    <input type="text" value="<?php echo e(old('username')); ?>" id="username" name="username" required>
                </div>
                <div>
                    <label><?php echo app('translator')->get('Your Password'); ?></label>
...
<?php endif; ?>
                ...
                <div>
                    <button type="submit"><?php echo app('translator')->get('Sign In'); ?></button>
                </div>
                <p><?php echo app('translator')->get("Don'\t have an account?"); ?> <a href="<?php echo e(route('user.register')); ?>" class="text-theme"><?php echo app('translator')->get('Sign Up'); ?></a></p>
                <p><a href="<?php echo e(route('user.password.request')); ?>" class="text-theme"><?php echo app('translator')->get('Forgot Password'); ?></a></p>
            </form>
        </div>
    </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make($activeTemplate . 'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u171472567/domains/yukotrader.com/public_html/core/resources/views/templates/basic/user/auth/login.blade.php ENDPATH**/ ?>