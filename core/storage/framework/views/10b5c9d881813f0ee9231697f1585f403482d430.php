                            ...
                            <li class="sidebar-menu-item <?php echo e(menuActive('admin.users.kyc.unverified')); ?>">
                                <a href="<?php echo e(route('admin.users.kyc.unverified')); ?>" class="nav-link">
                                    ...
                                    <?php if($kycUnverifiedUsersCount): ?>
                                        <span
                                            class="menu-badge pill bg--danger ms-auto"><?php echo e($kycUnverifiedUsersCount); ?></span>
                                    <?php endif; ?>
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item <?php echo e(menuActive('admin.users.kyc.pending')); ?>">
                                <a href="<?php echo e(route('admin.users.kyc.pending')); ?>" class="nav-link">
                                    ...
                                    <?php if($kycPendingUsersCount): ?>
                                        <span
                                            class="menu-badge pill bg--danger ms-auto"><?php echo e($kycPendingUsersCount); ?></span>
                                    <?php endif; ?>
                                </a>
                            </li>
...
<!--
    ...
    -->      <!--      <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="<?php echo e(menuActive('admin.pin*', 3)); ?>">
                        <i class="menu-icon las la-key"></i>
                        <span class="menu-title"><?php echo app('translator')->get('Manage Pins'); ?></span>
                    </a>
                    -->
                    <div class="sidebar-submenu <?php echo e(menuActive('admin.pin*', 2)); ?> ">
                        <ul>
                            <li class="sidebar-menu-item <?php echo e(menuActive('admin.pin.index')); ?> ">
                                <a href="<?php echo e(route('admin.pin.index')); ?>" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title"><?php echo app('translator')->get('All Pins'); ?></span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item <?php echo e(menuActive('admin.pin.user')); ?> ">
                                <a href="<?php echo e(route('admin.pin.user')); ?>" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title"><?php echo app('translator')->get('User Pins'); ?></span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item <?php echo e(menuActive('admin.pin.generate')); ?> ">
                                <a href="<?php echo e(route('admin.pin.generate')); ?>" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title"><?php echo app('translator')->get('Admin Pins'); ?></span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item <?php echo e(menuActive('admin.pin.used')); ?> ">
                                <a href="<?php echo e(route('admin.pin.used')); ?>" class="nav-link">
                                    <i class="menu-icon las la-lock-open"></i>
                                    <span class="menu-title"><?php echo app('translator')->get('Used Pins'); ?></span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item <?php echo e(menuActive('admin.pin.unused')); ?> ">
                                <a href="<?php echo e(route('admin.pin.unused')); ?>" class="nav-link">
                                    <i class="menu-icon las la-lock"></i>
                                    <span class="menu-title"><?php echo app('translator')->get('Unused Pins'); ?></span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu <?php echo e(menuActive('admin.report*', 2)); ?> ">
                        <ul>
                            ...
                            <li
                                class="sidebar-menu-item <?php echo e(menuActive(['admin.report.commissions', 'admin.report.commissions.search', 'admin.report.commissions.log'])); ?>">
                                <a href="<?php echo e(route('admin.report.commissions')); ?>" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title"><?php echo app('translator')->get('Commissions Log'); ?></span>
                                </a>
                            </li>

                            <li
                                class="sidebar-menu-item <?php echo e(menuActive(['admin.report.recharge', 'admin.report.recharge.search'])); ?>">
                                <a href="<?php echo e(route('admin.report.recharge')); ?>" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title"><?php echo app('translator')->get('Recharge Log'); ?></span>
                                </a>
                            </li>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/u171472567/domains/yukotrader.com/public_html/core/resources/views/admin/partials/sidenav.blade.php ENDPATH**/ ?>