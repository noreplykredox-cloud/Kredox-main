            ...
            <div class="col-lg-6">
                <div class="card custom--card primary-bg">
                    <div class="card-header">
                        <h5 class="card-title"><?php echo app('translator')->get('Withdraw'); ?></h5>
...
<script type="text/javascript">
    (function ($) {
            ...
            $('select[name=method_code]').change(function(){
                ...
                $('.charge').text(charge);
                if (resource.currency != '<?php echo e(__($general->cur_text)); ?>') {
...
<?php echo $__env->make($activeTemplate.'layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u171472567/domains/yukotrader.com/public_html/core/resources/views/templates/basic/user/withdraw/methods.blade.php ENDPATH**/ ?>