                ...
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="form-group">
                                    <label><?php echo app('translator')->get('E-Pin Generate Charge'); ?></label>
                                    <div class="input-group">
                                        <input type="text" id="epin_charge" class="form-control form-control-lg"
                                            value="<?php echo e(getAmount($general->epin_charge)); ?>" name="epin_charge"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" id="balance_transfer_percent_charge"
                                            ...
                                            value="<?php echo e(getAmount($general->balance_transfer_percent_charge)); ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" id="price" class="form-control form-control-lg"
                                            value="<?php echo e(getAmount($general->balance_transfer_fixed_charge)); ?>"
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u171472567/domains/yukotrader.com/public_html/core/resources/views/admin/setting/general.blade.php ENDPATH**/ ?>