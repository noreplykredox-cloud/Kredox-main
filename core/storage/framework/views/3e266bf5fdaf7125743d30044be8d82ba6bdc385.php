        ...
        <div class="col-lg-4 col-md-4 mb-30">
            <div class="card b-radius--10 overflow-hidden box--shadow1">
                <div class="card-body">
                    ...
                    <h5 class="mb-20 text-muted"><?php echo app('translator')->get('Withdraw Via'); ?> <?php echo e(@$withdrawal->method->name ?? 'Epin'); ?></h5>
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <?php if(@$withdrawal->method->name): ?>
                                <span class="fw-bold"><?php echo e(__(@$withdrawal->method->name)); ?></span>
                            <?php else: ?>
                                <span class="fw-bold"><?php echo app('translator')->get('Epin'); ?></span>
                            <?php endif; ?>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u171472567/domains/yukotrader.com/public_html/core/resources/views/admin/withdraw/detail.blade.php ENDPATH**/ ?>