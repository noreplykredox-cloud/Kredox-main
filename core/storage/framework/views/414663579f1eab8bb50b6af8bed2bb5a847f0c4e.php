                    ...
                    <form action="<?php echo e(route('user.deposit.insert')); ?>" method="post">
                        ...
                        <div class="card custom--card primary-bg">
                            <div class="card-header">
                                <h5 class="card-title"><?php echo app('translator')->get('Deposit'); ?></h5>
                            </div>
                            <div class="card-body">
...
<?php echo $__env->make($activeTemplate . 'layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u171472567/domains/yukotrader.com/public_html/core/resources/views/templates/basic/user/payment/deposit.blade.php ENDPATH**/ ?>