                        ...
                        <div class="row ">
                            ...
                            <div class="col-md-6">
                                <div class="row form-group">
                                    <div class="col-12">
                                        <label for="inputAttachments"><?php echo app('translator')->get('Attachments'); ?></label> <span
                                            class="text--danger"><?php echo app('translator')->get('Max 5 files can be uploaded. Maximum upload size is'); ?>
                                ...
                                <div class="col-md-3 border-end text-md-end text-start">
                                    ...
                                    <button class="btn btn-danger btn-sm my-3 confirmationBtn"
                                        ...
                                        data-action="<?php echo e(route('admin.ticket.delete', $message->id)); ?>"><i
                                            class="la la-trash"></i> <?php echo app('translator')->get('Delete'); ?></button>
                                </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u171472567/domains/yukotrader.com/public_html/core/resources/views/admin/support/reply.blade.php ENDPATH**/ ?>