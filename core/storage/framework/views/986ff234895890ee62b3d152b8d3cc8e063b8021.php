            ...
            display: block;
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="dashboard-item">
                        ...
                        <div class="dashboard-content">
                            <h5 class="title"><?php echo app('translator')->get('Contract Return'); ?></h5>
                            <h4 class="amount"><?php echo e($general->cur_sym); ?><?php echo e(showAmount($contractReturn)); ?></h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="dashboard-item">
                        ...
                        <div class="dashboard-content">
                            <h5 class="title"><?php echo app('translator')->get('Contract Received'); ?></h5>
                            
                            <h4 class="amount">$<?php echo e(showAmount($contractReceived)); ?></h4>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="dashboard-item">
                        ...
                        <div class="dashboard-content">
                            <h5 class="title"><?php echo app('translator')->get('Contract Balance'); ?></h5>
                            <h4 class="amount"><?php echo e($general->cur_sym); ?><?php echo e(showAmount($contractBalance)); ?></h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="dashboard-item">
                        ...
                        <div class="dashboard-content">
                            <h5 class="title"><?php echo app('translator')->get('Daily Portfolio'); ?></h5>
                            <h4 class="amount"><?php echo e($general->cur_sym); ?><?php echo e(showAmount($dailyIncome)); ?></h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="dashboard-item">
                        ...
                        <div class="dashboard-content">
                            <h5 class="title"><?php echo app('translator')->get('Total Earned USDT'); ?></h5>
                            <h4 class="amount"><?php echo e($general->cur_sym); ?><?php echo e(showAmount($totalEarnedUsdt)); ?></h4>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make($activeTemplate . 'layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sptspl-trade/htdocs/trade.sptspl.com/public/core/resources/views/templates/basic/user/dashboard.blade.php ENDPATH**/ ?>