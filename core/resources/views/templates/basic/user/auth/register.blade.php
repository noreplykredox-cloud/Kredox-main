        ...
        <div class="split-container">
            ...
            <div class="content-section">
                <div class="content-wrapper">
                    ...
                    <p class="content-subtitle">
                        Create your account and unlock access to advanced trading tools, real-time analytics, and expert market
                        insights.
                    </p>
            ...
            <div class="register-section">
                <div class="register-box">
                    ...
                    <form action="{{ route('user.register') }}" method="POST" class="register-form verify-gcaptcha"
                        ...
                        <div class="form-grid">
                            @if (session()->get('reference') != null)
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-input" name="referBy"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-input @error('username') is-invalid @enderror checkUser"
                                            name="username" placeholder="@lang('Username')" value="{{ old('username') }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-input @error('firstname') is-invalid @enderror"
                                        name="firstname" placeholder="@lang('Enter First Name')" value="{{ old('firstname') }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-input @error('lastname') is-invalid @enderror"
                                        name="lastname" placeholder="@lang('Enter Last Name')" value="{{ old('lastname') }}"
                                        minlength="2" maxlength="50" required>
                                </div>
                                @error('lastname')
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="email" class="form-input @error('email') is-invalid @enderror checkUser"
                                        name="email" placeholder="@lang('Email Address')" value="{{ old('email') }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="tel" class="form-input @error('mobile') is-invalid @enderror checkUser"
                                        name="mobile" placeholder="@lang('Your Phone Number')" value="{{ old('mobile') }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="password" class="form-input @error('password') is-invalid @enderror"
                                        id="password" name="password" placeholder="@lang('Enter Password')" minlength="6"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="password"
                                        ...
                                        placeholder="@lang('Confirm Password')" minlength="6" maxlength="32" required>
                            ...
                            @if ($general->agree)
                                <div class="checkgroup span-2">
                                    <input type="checkbox" id="agree" name="agree" required {{ old('agree') ? 'checked' : '' }}>
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                document.querySelectorAll('.toggle-password').forEach(icon => {
                    icon.addEventListener('click', function () {
                        // Try to find the input sibling in the same input-group container first (highly robust)
                        let passwordInput = this.parentElement.querySelector('input');

                        // Fallback to data-target ID if not found
                        if (!passwordInput) {
                ...
                function validateField(input) {
                    ...
                    input.classList.remove('is-invalid-red');
                    const formGroup = input.closest('.form-group');
                    if (formGroup) {
                        const existingFeedback = formGroup.querySelector('.invalid-feedback-ajax, .invalid-feedback');
                    ...
                    // If it is not empty, check other validations
                    if (isValid && input.value.trim()) {
                        ...
                        if (name === 'email') {
                            ...
                            if (!emailRegex.test(input.value) || input.value.length > 100) {
                                isValid = false;
                    ...
                    // If checkbox (agree to terms)
                    if (input.getAttribute('type') === 'checkbox' && input.hasAttribute('required') && !input.checked) {
                        isValid = false;
                        message = "You must agree with our policies.";
                    }
                ...
                if (registerForm && submitBtn) {
                    registerForm.addEventListener('submit', function (e) {
                        ...
                        const inputsToValidate = registerForm.querySelectorAll('.form-input, input[type="checkbox"]');
                ...
                // Input focus, blur and validation effects
                ...
                inputs.forEach(input => {
                    ...
                    // Validate on real-time typing/input
