...
Route::middleware('admin')->group(function () {
    ...
    Route::controller('ManageUsersController')->name('users.')->prefix('users')->group(function () {
        ...
        Route::post('manual-payment/{id}', 'manualPayment')->name('manual.payment');
        Route::post('manual-payment/toggle/{id}', 'toggleManualPayment')->name('manual.payment.toggle');
        Route::delete('manual-payment/delete/{id}', 'deleteManualPayment')->name('manual.payment.delete');
